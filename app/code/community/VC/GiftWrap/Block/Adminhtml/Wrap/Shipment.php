<?php
class VC_GiftWrap_Block_Adminhtml_Wrap_Shipment extends VC_GiftWrap_Block_Adminhtml_Wrap
{
    public function getShipmentId()
    {
		...
		$id = $this->getRequest()->getParam('shipment_id', $this->getRequest()->getParam('invoice_id',0));
        return $id;
    }
	...
	protected function _appendItem($group, $item) {
		$group['product_qty_shipped'] = $item->getIsrQty();
		return $group;
	}
