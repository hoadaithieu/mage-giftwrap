<?php
class VC_GiftWrap_Block_Adminhtml_Card_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		$form = new Varien_Data_Form();
		$this->setForm($form);
		$fieldset = $form->addFieldset('card_form', array('legend'=>Mage::helper('vc_giftwrap')->__('Card information')));
		$priceGroup = Mage::registry('card_data');
		...
		$fieldset->addField('max_characters', 'text', array(
		  'label'     => Mage::helper('vc_giftwrap')->__('Max Length of Message'),
		  'class'     => 'required-entry',
		  'required'  => true,
		  'name'      => 'max_characters',
		));
		...
		if ( Mage::registry('card_data') ) {
			$data = Mage::registry('card_data')->getData();
