<?php
class VC_GiftWrap_Block_Adminhtml_Card_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	**/
	...
	protected function _prepareCollection() {
		...
		if ($storeId > 0) {
			...
			->joinInner(
				array('ps' => Mage::getSingleton('core/resource')->getTableName('vc_giftwrap/card_store')),
				'ps.card_id = main_table.card_id AND ps.store_id = '. $storeId,
	...
	**/
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('max_characters', array(
		  'header'    => Mage::helper('vc_giftwrap')->__('Max Length of Message'),
		  'align'     =>'left',
	...
	**/
	...
	protected function _prepareMassaction() {
		$this->setMassactionIdField('card_id');
