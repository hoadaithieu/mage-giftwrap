 ...
 */
class VC_GiftWrap_Model_Sales_Order_Pdf_Items_Shipment_Giftwrap extends Mage_Sales_Model_Order_Pdf_Items_Abstract
{
    ...
    public function draw()
    {
        ...
        $lines[0][] = array(
			'renderer' => 'vc_giftwrap/sales_order_pdf_renderer_shipment_wrappeditems',
        ...
        $lines[0][] = array(
			'renderer' => 'vc_giftwrap/sales_order_pdf_renderer_shipment_subtotal',
			'info' => array('order' => $order, 'group' => $item->getGroupItem()),
            'text' => '',
            'feed' => 565,
			'font'  => 'bold',
